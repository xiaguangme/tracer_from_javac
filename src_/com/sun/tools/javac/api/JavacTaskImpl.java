...
public class JavacTaskImpl extends JavacTask {
    ...
    static private String[] toArray(Iterable<String> flags, Iterable<String> classes) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(flags, classes);
    ...
    public void setLocale(Locale locale) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(locale);
	if (used.get())
            throw new IllegalStateException();
    }
    ...
    private TaskListener wrap(final TaskListener tl) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tl);
    ...
    public void setTaskListener(TaskListener taskListener) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(taskListener);
    ...
    public Iterable<? extends Element> analyze(Iterable<? extends TypeElement> classes) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(classes);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(queue, elems);
    ...
    public Iterable<? extends Tree> pathFor(CompilationUnitTree unit, Tree node) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(unit, node);
    ...
    abstract class Filter {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(list, classes);
    ...
    public void updateContext(Context newContext) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(newContext);
	context = newContext;
    }
    ...
    public Type parseType(String expr, TypeElement scope) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(expr, scope);
