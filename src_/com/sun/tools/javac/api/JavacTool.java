...
public final class JavacTool implements JavaCompiler {
    ...
    private void setOption1(String name, OptionKind kind, Object... args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, kind, args);
    ...
    public void setOption(String name, Object... args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, args);
    ...
    private static boolean match(OptionKind clientKind, OptionKind optionKind) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(clientKind, optionKind);
    ...
    public JavacFileManager getStandardFileManager(
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(diagnosticListener, locale, charset);
                             ...
                             Iterable<? extends JavaFileObject> compilationUnits)
    {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(out, fileManager, diagnosticListener, options, classes, compilationUnits);
                                       ...
                                       Iterable<String> options)
    {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(context, fileManager, options);
	if (options == null)
            return;
    ...
    public int run(InputStream in, OutputStream out, OutputStream err, String... arguments) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(in, out, err, arguments);
	if (err == null)
            err = System.err;
