...
public class JavacTrees extends Trees {
    ...
    public static JavacTrees instance(JavaCompiler.CompilationTask task) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(task);
	...
	return new SourcePositions() {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(file, tree);
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(scope, member, type);
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    private Env<AttrContext> attribStatToTree(JCTree stat, Env<AttrContext>env, JCTree tree) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(stat, env, tree);
    ...
    static class Copier extends TreeCopier<JCTree> {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, leaf);
