...
public class Lint
{
    ...
    public Lint augment(List<Attribute.Compound> attrs, long flags) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(attrs, flags);
    ...
    public boolean isEnabled(LintCategory lc) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(lc);
    ...
    protected static class AugmentVisitor implements Attribute.Visitor {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(parent, attr);
	initSyms();
            this.parent = parent;
            lint = null;
            attr.accept(this);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(parent, attrs);
	initSyms();
            this.parent = parent;
            lint = null;
