...
public class Scope {
    ...
    public void enter(Symbol sym, Scope s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, s);
	enter(sym, s, s);
    }
    ...
    public void enter(Symbol sym, Scope s, Scope origin) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, s, origin);
	assert shared == 0;
    ...
    Entry makeEntry(Symbol sym, Entry shadowed, Entry sibling, Scope scope, Scope origin) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, shadowed, sibling, scope, origin);
