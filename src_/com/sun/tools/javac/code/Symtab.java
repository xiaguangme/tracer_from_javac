...
public class Symtab {
    ...
    public void initType(Type type, ClassSymbol c) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(type, c);
	type.tsym = c;
    ...
    public void initType(Type type, String name) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(type, name);
	initType(
            type,
            new ClassSymbol(
    ...
    public void initType(Type type, String name, String bname) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(type, name, bname);
	initType(type, name);
    ...
    private VarSymbol enterConstant(String name, Type type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, type);
    ...
    private void enterBinop(String name,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, left, right, res, opcode);
    ...
    private void enterBinop(String name,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, left, right, res, opcode1, opcode2);
	enterBinop(
    ...
    private OperatorSymbol enterUnop(String name,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, arg, res, opcode);
	OperatorSymbol sym =
