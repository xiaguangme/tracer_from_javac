...
public class Type implements PrimitiveType {
    ...
    public <R,S> R accept(Type.Visitor<R,S> v, S s) {  
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(v, s);
    ...
    public static List<Type> map(List<Type> ts, Mapping f) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ts, f);
	if (ts.nonEmpty()) {
    ...
    public Type constType(Object constValue) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(constValue);
    ...
    public String argtypes(boolean varargs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(varargs);
    ...
    */
    ...
    public static boolean contains(List<Type> ts, Type t) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ts, t);
	for (List<Type> l = ts;
...
//where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, longform);
	...
	Type outer = getEnclosingType();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(elem);
	return
                elem == this
                || (isParameterized()
	...
	return qtype.getUpperBound(); }
        public Object clone() {  
		org.simonme.tracer.trace.Tracer.traceMethodInvoke();
	DelegatedType t = (DelegatedType)super.clone(); t.qtype = (Type)qtype.clone(); return t; }
        public boolean isErroneous() {  
		org.simonme.tracer.trace.Tracer.traceMethodInvoke();
