...
public class Types {
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, ignored);
	if (t.isSuperBound())
    ...
    public Type asSub(Type t, Symbol sym) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, sym);
    ...
    public boolean isConvertible(Type t, Type s, Warner warn) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, s, warn);
    ...
    public boolean isConvertible(Type t, Type s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, s);
    ...
    public boolean isSubtype(Type t, Type s, boolean capture) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, s, capture);
	if (t == s)
            return true;
    ...
    public boolean isSubtypeUnchecked(Type t, List<Type> ts, Warner warn) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, ts, warn);
    ...
    public boolean isSubtypes(List<Type> ts, List<Type> ss) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ts, ss);
    ...
    public boolean isSubtypesUnchecked(List<Type> ts, List<Type> ss, Warner warn) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ts, ss, warn);
	while (ts.tail != null && ss.tail != null
               /*inlined: ts.nonEmpty() && ss.nonEmpty()*/ &&
    ...
    public boolean isCaptureOf(Type s, WildcardType t) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(s, t);
    ...
    public Type makeCompoundType(List<Type> bounds,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bounds, supertype);
	ClassSymbol bc =
    ...
    public Type makeCompoundType(List<Type> bounds) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bounds);
    ...
    public Type makeCompoundType(Type bound1, Type bound2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bound1, bound2);
    ...
    public void setBounds(TypeVar t, List<Type> bounds, Type supertype) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, bounds, supertype);
    ...
    public void setBounds(TypeVar t, List<Type> bounds) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, bounds);
	Type supertype = (bounds.head.tsym.flags() & INTERFACE) != 0 ?
            supertype(bounds.head) : null;
    ...
    public List<Type> subst(List<Type> ts,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ts, from, to);
    ...
    public Type subst(Type t, List<Type> from, List<Type> to) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, from, to);
    ...
    public List<Type> substBounds(List<Type> tvars,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tvars, from, to);
	if (tvars.isEmpty())
            return tvars;
    ...
    public List<Type> newInstances(List<Type> tvars) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tvars);
	...
	StringBuffer s = new StringBuffer();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, buf);
	buf.append(t);
            if (t.bound == null ||
    ...
    public List<Type> insert(List<Type> cl, Type t) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(cl, t);
    ...
    public List<Type> union(List<Type> cl1, List<Type> cl2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(cl1, cl2);
	if (cl1.isEmpty()) {
            return cl2;
        } else if (cl2.isEmpty()) {
            return cl1;
	...
	return 127 * Types.this.hashCode(t1) + Types.this.hashCode(t2);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(obj);
	if (!(obj instanceof TypePair))
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(c1, c2);
    ...
    private Type compoundMin(List<Type> cl) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(cl);
    ...
    public Type lub(Type t1, Type t2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t1, t2);
    ...
    public boolean resultSubtype(Type t, Type s, Warner warner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, s, warner);
    ...
    public boolean returnTypeSubstitutable(Type r1, Type r2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(r1, r2);
    ...
    public boolean returnTypeSubstitutable(Type r1,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(r1, r2, r2res, warner);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(types);
    ...
    private List<Type> upperBounds(List<Type> ss) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ss);
    ...
    private boolean sideCast(Type from, Type to, Warner warn) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(from, to, warn);
    ...
    private boolean giveWarning(Type from, Type to) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(from, to);
    ...
    public void adapt(Type source,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(source, target, from, to);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(source, target, from, to, mapping);
    ...
    private Type rewriteQuantifiers(Type t, boolean high, boolean rewriteTypeVars) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, high, rewriteTypeVars);
    ...
    private WildcardType makeExtendsWildcard(Type bound, TypeVar formal) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bound, formal);
