...
public class Attr extends JCTree.Visitor {
    ...
    Type check(JCTree tree, Type owntype, int ownkind, int pkind, Type pt) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, owntype, ownkind, pkind, pt);
    ...
    boolean isAssignableAsBlankFinal(VarSymbol v, Env<AttrContext> env) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(v, env);
    ...
    void checkAssignable(DiagnosticPosition pos, VarSymbol v, JCTree base, Env<AttrContext> env) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, v, base, env);
	if ((v.flags() & FINAL) != 0 &&
            ((v.flags() & HASINIT) != 0
             ||
             !((base == null ||
    ...
    Symbol thisSym(DiagnosticPosition pos, Env<AttrContext> env) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env);
    ...
    public Symbol attribIdent(JCTree tree, JCCompilationUnit topLevel) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, topLevel);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(node, env);
    ...
    public Type coerce(Type etype, Type ttype) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(etype, ttype);
	return cfolder.coerce(etype, ttype);
    }

    public Type attribType(JCTree node, TypeSymbol sym) {
         
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(node, sym);
    ...
    public Env<AttrContext> attribExprToTree(JCTree expr, Env<AttrContext> env, JCTree tree) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(expr, env, tree);
	breakTree = tree;
    ...
    public Env<AttrContext> attribStatToTree(JCTree stmt, Env<AttrContext> env, JCTree tree) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(stmt, env, tree);
	breakTree = tree;
        JavaFileObject prev = log.useSource(null);
        try {
            attribStat(stmt, env);
 ...
 *************************************************************************/
    ...
    Type attribTree(JCTree tree, Env<AttrContext> env, int pkind, Type pt) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, env, pkind, pt);
    ...
    public Type attribExpr(JCTree tree, Env<AttrContext> env, Type pt) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, env, pt);
    ...
    Type attribExpr(JCTree tree, Env<AttrContext> env) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, env);
    ...
    List<Type> attribExprs(List<JCExpression> trees, Env<AttrContext> env, Type pt) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(trees, env, pt);
    ...
    <T extends JCTree> void attribStats(List<T> trees, Env<AttrContext> env) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(trees, env);
    ...
    void attribTypeVariables(List<JCTypeParameter> typarams, Env<AttrContext> env) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(typarams, env);
    ...
    void attribAnnotationTypes(List<JCAnnotation> annotations,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotations, env);
    ...
    Type attribBase(JCTree tree,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, env, classExpected, interfaceExpected, checkExtensible);
    ...
    Type checkBase(Type t,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, tree, env, classExpected, interfaceExpected, checkExtensible);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(stats, switchScope);
    ...
    private Symbol enumConstant(JCTree tree, Type enumType) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, enumType);
    ...
    //where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, condtype, thentype, elsetype);
    ...
    //where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, tag, label, env);
	Env<AttrContext> env1 = env;
            LOOP:
            while (env1 != null) {
	...
	JCMethodDecl enclMethod = env.enclMethod;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(argtypes, typeargtypes);
...
//          System.out.println(clazz + " generated.");//DEBUG
    ...
    public JCExpression makeNullCheck(JCExpression arg) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(arg);
    ...
    //where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, site, env, pt, pkind);
	DiagnosticPosition pos = tree.pos();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, site, sym, env, pkind, pt, useVarargs);
...
//                             Resolve.isStatic(env));//DEBUG
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, env, v, onlyWarning);
	if (v.pos > tree.pos &&
                v.owner.kind == TYP &&
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, env, v);
    ...
    public Type checkMethod(Type site,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(site, sym, env, argtrees, argtypes, typeargtypes, useVarargs);
	if (allowGenerics &&
            (sym.flags() & STATIC) == 0 &&
            (site.tag == CLASS || site.tag == TYPEVAR)) {
    ...
    private void assertConvertible(JCTree tree, Type actual, Type formal, Warner warn) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, actual, formal, warn);
    ...
    Type litType(int tag) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tag);
	...
	try {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, c);
