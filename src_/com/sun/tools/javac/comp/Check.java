 ...
 **************************************************************************/
    ...
    Lint setLint(Lint newLint) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(newLint);
	Lint prev = lint;
        lint = newLint;
        return prev;
    }
    ...
    public void warnUnchecked(DiagnosticPosition pos, String msg, Object... args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, msg, args);
    ...
    public Type completionError(DiagnosticPosition pos, CompletionFailure ex) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, ex);
    ...
    Type typeError(DiagnosticPosition pos, Object problem, Type found, Type req) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, problem, found, req);
    ...
    Type typeError(DiagnosticPosition pos, String problem, Type found, Type req, Object explanation) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, problem, found, req, explanation);
    ...
    Type typeTagError(DiagnosticPosition pos, Object required, Object found) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, required, found);
    ...
    void varargsDuplicateError(DiagnosticPosition pos, Symbol sym1, Symbol sym2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, sym1, sym2);
 ...
 *************************************************************************/
    ...
    void checkTransparentVar(DiagnosticPosition pos, VarSymbol v, Scope s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, v, s);
	if (s.next != null) {
    ...
    void checkTransparentClass(DiagnosticPosition pos, ClassSymbol c, Scope s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, c, s);
	if (s.next != null) {
    ...
    boolean checkUniqueClassName(DiagnosticPosition pos, Name name, Scope s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, name, s);
 ...
 **************************************************************************/
    ...
    Type checkType(DiagnosticPosition pos, Type found, Type req) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, found, req);
	if (req.tag == ERROR)
            return req;
        if (found.tag == FORALL)
    ...
    Type instantiatePoly(DiagnosticPosition pos, ForAll t, Type pt, Warner warn) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, t, pt, warn);
...
//where
    ...
    private void checkExtends(DiagnosticPosition pos, Type a, TypeVar bs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, a, bs);
	if (a.isUnbound()) {
            return;
    ...
    Type checkNonVoid(DiagnosticPosition pos, Type t) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, t);
	if (t.tag == VOID) {
    ...
    Type checkClassType(DiagnosticPosition pos, Type t, boolean noBounds) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, t, noBounds);
    ...
    boolean checkDisjoint(DiagnosticPosition pos, long flags, long set1, long set2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, flags, set1, set2);
    ...
    long checkFlags(DiagnosticPosition pos, long flags, Symbol sym, JCTree tree) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, flags, sym, tree);
	long mask;
        long implicit = 0;
        switch (sym.kind) {
        case VAR:
 ...
 **************************************************************************/
    ...
    boolean subset(Type t, List<Type> ts) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, ts);
    ...
    List<Type> union(List<Type> ts1, List<Type> ts2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ts1, ts2);
	List<Type> ts = ts1;
    ...
    boolean isUnchecked(ClassSymbol exc) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(exc);
	return
            exc.kind == ERR ||
    ...
    boolean isUnchecked(DiagnosticPosition pos, Type exc) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, exc);
	try {
    ...
    boolean isHandled(Type exc, List<Type> handled) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(exc, handled);
    ...
    List<Type> unHandled(List<Type> thrown, List<Type> handled) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(thrown, handled);
 ...
 **************************************************************************/
    ...
    static Object cannotOverride(MethodSymbol m, MethodSymbol other) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(m, other);
	String key;
    ...
    void checkOverride(JCTree tree,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, m, other, origin);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(m, origin);
    ...
    public void checkCompatibleConcretes(DiagnosticPosition pos, Type site) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, site);
    ...
    public boolean checkCompatibleAbstracts(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, t1, t2);
    ...
    public boolean checkCompatibleAbstracts(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, t1, t2, site);
    ...
    private Symbol firstIncompatibility(Type t1, Type t2, Type site) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t1, t2, site);
    ...
    private void closure(Type t, Map<TypeSymbol,Type> typeMap) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, typeMap);
    ...
    private void closure(Type t, Map<TypeSymbol,Type> typesSkip, Map<TypeSymbol,Type> typeMap) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, typesSkip, typeMap);
	if (t.tag != CLASS) return;
    ...
    void checkOverride(JCTree tree, MethodSymbol m) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, m);
...
//where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(impl, c);
    ...
    private void checkNonCyclic1(DiagnosticPosition pos, Type t, Set<TypeVar> seen) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, t, seen);
	final TypeVar tv;
        if (seen.contains(t)) {
            tv = (TypeVar)t;
...
//where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, ic);
    ...
    void checkClassBounds(DiagnosticPosition pos, Type type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, type);
...
//where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, seensofar, type);
    ...
    void checkNotRepeated(DiagnosticPosition pos, Type it, Set<Type> its) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, it, its);
	if (its.contains(it))
 ...
 **************************************************************************/
    ...
    void validateAnnotationType(JCTree restype) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(restype);
	if (restype != null) {
    ...
    void validateAnnotationMethod(DiagnosticPosition pos, MethodSymbol m) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, m);
    ...
    public void validateAnnotations(List<JCAnnotation> annotations, Symbol s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotations, s);
    ...
    public void validateAnnotation(JCAnnotation a, Symbol s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(a, s);
    ...
    boolean isOverrider(Symbol s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(s);
    ...
    void checkDeprecatedAnnotation(DiagnosticPosition pos, Symbol s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, s);
	if (allowAnnotations &&
 ...
 **************************************************************************/
    ...
    void checkNonCyclicElementsInternal(DiagnosticPosition pos, TypeSymbol tsym) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, tsym);
 ...
 **************************************************************************/
    ...
    private void checkCyclicConstructor(JCClassDecl tree, Symbol ctor,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, ctor, callMap);
 ...
 **************************************************************************/
    ...
    int checkOperator(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, operator, tag, left, right);
    ...
    void checkDivZero(DiagnosticPosition pos, Symbol operator, Type operand) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, operator, operand);
    ...
    private boolean checkUniqueImport(DiagnosticPosition pos, Symbol sym, Scope s, boolean staticImport) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, sym, s, staticImport);
    ...
    public Warner castWarner(DiagnosticPosition pos, Type found, Type expected) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, found, expected);
