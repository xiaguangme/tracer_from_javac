...
strictfp class ConstFold {
    ...
    */
    ...
    Type fold(int opcode, List<Type> argtypes) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(opcode, argtypes);
    ...
    Type fold1(int opcode, Type operand) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(opcode, operand);
	try {
    ...
    Type fold2(int opcode, Type left, Type right) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(opcode, left, right);
	try {
