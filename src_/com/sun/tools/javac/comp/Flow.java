...
public class Flow extends TreeScanner {
    ...
    void markThrown(JCTree tree, Type exc) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, exc);
    ...
    boolean resolveBreaks(JCTree tree,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, oldPendingExits);
 ...
 *************************************************************************/
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(stats, inits, uninits);
 ...
 *************************************************************************/
    ...
    public void analyzeTree(JCTree tree, TreeMaker make) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, make);
	try {
            this.make = make;
            inits = new Bits();
            uninits = new Bits();
