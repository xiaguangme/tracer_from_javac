...
public class Infer {
	...
	this.diagnostic = JCDiagnostic.fragment(key);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, arg1);
	this.diagnostic = JCDiagnostic.fragment(key, arg1);
            return this;
        }
        NoInstanceException setMessage(String key, Object arg1, Object arg2) {
             
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, arg1, arg2);
	this.diagnostic = JCDiagnostic.fragment(key, arg1, arg2);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, arg1, arg2, arg3);
 ...
 ***************************************************************************/
    ...
    void maximizeInst(UndetVar that, Warner warn) throws NoInstanceException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(that, warn);
	if (that.inst == null) {
 ...
 ***************************************************************************/
    ...
    public Type instantiateExpr(ForAll that,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(that, to, warn);
    ...
    public Type instantiateMethod(List<Type> tvars,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tvars, mt, argtypes, allowBoxing, useVarargs, warn);
    ...
    //where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(that, to, tvars, warn);
	List<Type> targs;
            try {
    ...
    private void checkWithinBounds(List<Type> tvars,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tvars, arguments, warn);
