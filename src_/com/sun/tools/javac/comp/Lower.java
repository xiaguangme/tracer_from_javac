 ...
 *************************************************************************/
    ...
    JCClassDecl classDef(ClassSymbol c) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(c);
	...
	result = tree;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(_sym);
	Symbol sym = _sym;
    ...
    EnumMapping mapForEnum(DiagnosticPosition pos, TypeSymbol enumClass) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, enumClass);
 ...
 *************************************************************************/
    ...
    JCNewClass makeNewClass(Type ctype, List<JCExpression> args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ctype, args);
    ...
    JCUnary makeUnary(int optag, JCExpression arg) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(optag, arg);
    ...
    JCBinary makeBinary(int optag, JCExpression lhs, JCExpression rhs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(optag, lhs, rhs);
    ...
    ClassSymbol makeEmptyClass(long flags, ClassSymbol owner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(flags, owner);
 ...
 *************************************************************************/
    ...
    private void duplicateError(DiagnosticPosition pos, Symbol sym) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, sym);
    ...
    private void enterSynthetic(DiagnosticPosition pos, Symbol sym, Scope s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, sym, s);
    ...
    private Symbol lookupSynthetic(Name name, Scope s) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, s);
    ...
    private MethodSymbol lookupMethod(DiagnosticPosition pos, Name name, Type qual, List<Type> args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, name, qual, args);
    ...
    private MethodSymbol lookupConstructor(DiagnosticPosition pos, Type qual, List<Type> args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, qual, args);
    ...
    private VarSymbol lookupField(DiagnosticPosition pos, Type qual, Name name) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, qual, name);
 ...
 *************************************************************************/
    ...
    private static int accessCode(int bytecode) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bytecode);
    ...
    private static int accessCode(JCTree tree, JCTree enclOp) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, enclOp);
	if (enclOp == null)
            return DEREFcode;
    ...
    private OperatorSymbol binaryAccessOperator(int acode) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(acode);
    ...
    private static int treeTag(OperatorSymbol operator) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(operator);
    ...
    Name accessName(int anum, int acode) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(anum, acode);
    ...
    MethodSymbol accessSymbol(Symbol sym, JCTree tree, JCTree enclOp,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, tree, enclOp, protAccess, refSuper);
    ...
    boolean needsProtectedAccess(Symbol sym, JCTree tree) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, tree);
    ...
    ClassSymbol accessClass(Symbol sym, boolean protAccess, JCTree tree) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, protAccess, tree);
	if (protAccess) {
    ...
    JCExpression access(Symbol sym, JCExpression tree, JCExpression enclOp, boolean refSuper) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, tree, enclOp, refSuper);
    ...
    Symbol accessConstructor(DiagnosticPosition pos, Symbol constr) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, constr);
...
//      System.err.println("access " + vsym + " with " + accessor);//DEBUG
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, vsym, accessor, acode);
    ...
    JCTree accessConstructorDef(int pos, Symbol constr, MethodSymbol accessor) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, constr, accessor);
	make.at(pos);
 ...
 *************************************************************************/
    ...
    List<JCVariableDecl> freevarDefs(int pos, List<VarSymbol> freevars, Symbol owner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, freevars, owner);
    ...
    Name outerThisName(Type type, Symbol owner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(type, owner);
    ...
    JCVariableDecl outerThisDef(int pos, Symbol owner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, owner);
	long flags = FINAL | SYNTHETIC;
        if (owner.kind == TYP &&
            target.usePrivateSyntheticFields())
            flags |= PRIVATE;
    ...
    List<JCExpression> loadFreevars(DiagnosticPosition pos, List<VarSymbol> freevars) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, freevars);
	List<JCExpression> args = List.nil();
        for (List<VarSymbol> l = freevars; l.nonEmpty(); l = l.tail)
...
//where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, v);
    ...
    JCExpression makeThis(DiagnosticPosition pos, TypeSymbol c) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, c);
	if (currentClass == c) {
    ...
    JCExpression makeOwnerThis(DiagnosticPosition pos, Symbol sym, boolean preciseMatch) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, sym, preciseMatch);
	Symbol c = sym.owner;
    ...
    JCStatement initField(int pos, Name name) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, name);
 ...
 *************************************************************************/
    ...
    JCBlock classDollarSymBody(DiagnosticPosition pos, JCMethodDecl md) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, md);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(left, name, args);
    ...
    private Name cacheName(String sig) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sig);
    ...
    private VarSymbol cacheSym(DiagnosticPosition pos, String sig) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, sig);
	ClassSymbol outerCacheClass = outerCacheClass();
    ...
    private JCExpression classOfType(Type type, DiagnosticPosition pos) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(type, pos);
	switch (type.tag) {
 ...
 *************************************************************************/
    ...
    JCTree abstractRval(JCTree rval, Type type, TreeBuilder builder) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(rval, type, builder);
    ...
    JCTree abstractRval(JCTree rval, TreeBuilder builder) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(rval, builder);
    ...
    JCTree abstractLval(JCTree lval, final TreeBuilder builder) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(lval, builder);
	lval = TreeInfo.skipParens(lval);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(selected);
	return builder.build(make.Select((JCExpression)selected, s.sym));
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(indexed);
	return abstractRval(i.index, syms.intType, new TreeBuilder() {
                                public JCTree build(final JCTree index) {
                                     
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(index);
    ...
    JCTree makeComma(final JCTree expr1, final JCTree expr2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(expr1, expr2);
	return abstractRval(expr1, new TreeBuilder() {
                public JCTree build(final JCTree discarded) {
                     
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(discarded);
	return expr2;
                }
            });
    }
 ...
 *************************************************************************/
    ...
    public <T extends JCTree> T translate(T tree, Type type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, type);
    ...
    public <T extends JCTree> List<T> translate(List<T> trees, JCExpression enclOp) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(trees, enclOp);
	JCExpression prevEnclOp = this.enclOp;
        this.enclOp = enclOp;
    ...
    public <T extends JCTree> List<T> translate(List<T> trees, Type type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(trees, type);
    ...
    private void visitEnumConstantDef(JCVariableDecl var, int ordinal) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(var, ordinal);
...
//where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, pt);
    ...
    List<JCExpression> boxArgs(List<Type> parameters, List<JCExpression> _args, Type varargsElement) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(parameters, _args, varargsElement);
    ...
    JCExpression boxPrimitive(JCExpression tree, Type box) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, box);
	make_at(tree.pos());
    ...
    JCExpression unbox(JCExpression tree, Type primitive) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, primitive);
	...
	final boolean cast = tree.arg.getTag() == JCTree.TYPECAST;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tmp1);
	return abstractRval(tmp1, tree.arg.type, new TreeBuilder() {
                            public JCTree build(final JCTree tmp2) {
                                 
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tmp2);
	...
	make_at(tree.expr.pos());
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(body, src, dest);
 ...
 *************************************************************************/
    ...
    public List<JCTree> translateTopLevelClass(Env<AttrContext> env, JCTree cdef, TreeMaker make) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, cdef, make);
    ...
    private void addEnumCompatibleMembers(JCClassDecl cdef) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(cdef);
	make_at(null);
    ...
    private MethodSymbol addEnumFieldOrdinalMethod(JCClassDecl cdef, VarSymbol ordinalSymbol) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(cdef, ordinalSymbol);
    ...
    private MethodSymbol addEnumFieldNameMethod(JCClassDecl cdef, VarSymbol nameSymbol) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(cdef, nameSymbol);
