...
public class MemberEnter extends JCTree.Visitor implements Completer {
    ...
    private void importAll(int pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, tsym, env);
	...
	final JavaFileObject sourcefile = env.toplevel.sourcefile;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tsym);
    ...
    boolean staticImportAccessible(Symbol sym, PackageSymbol packge) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, packge);
    ...
    private void importNamedStatic(final DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, tsym, name, env);
	if (tsym.kind != TYP) {
    ...
    Type signature(List<JCTypeParameter> typarams,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(typarams, params, res, thrown, env);
 ...
 *********************************************************************/
    ...
    void annotateLater(final List<JCAnnotation> annotations,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotations, localEnv, s);
    ...
    private boolean hasDeprecatedAnnotation(List<JCAnnotation> annotations) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotations);
    ...
    private void enterAnnotations(List<JCAnnotation> annotations,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotations, env, s);
    ...
    void annotateDefaultValueLater(final JCExpression defaultValue,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(defaultValue, localEnv, m);
	annotate.later(new Annotate.Annotator() {
                public String toString() {
 ...
 ****************************************************************************/
    ...
    JCTree DefaultConstructor(TreeMaker make,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(make, c, typarams, argtypes, thrown, flags, based);
    ...
    JCExpressionStatement SuperCall(TreeMaker make,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(make, typarams, params, based);
	JCExpression meth;
        if (based) {
