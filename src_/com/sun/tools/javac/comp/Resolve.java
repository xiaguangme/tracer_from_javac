 ...
 *************************************************************************/
    ...
    public boolean isAccessible(Env<AttrContext> env, TypeSymbol c) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, c);
    ...
    //where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(c, base);
    ...
    boolean isAccessible(Env<AttrContext> env, Type t) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, t);
	return (t.tag == ARRAY)
    ...
    public boolean isAccessible(Env<AttrContext> env, Type site, Symbol sym) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, sym);
    ...
    //where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, c, site);
	while (c != null &&
    ...
    Type rawInstantiate(Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, m, argtypes, typeargtypes, allowBoxing, useVarargs, warn);
    ...
    boolean argumentsAcceptable(List<Type> argtypes,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(argtypes, formals, allowBoxing, useVarargs, warn);
 ...
 ****************************************************************************/
    ...
    Symbol findField(Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, name, c);
    ...
    public VarSymbol resolveInternalField(DiagnosticPosition pos, Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, site, name);
    ...
    Symbol findVar(Env<AttrContext> env, Name name) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, name);
	Symbol bestSoFar = varNotFound;
        Symbol sym;
    ...
    Symbol selectBest(Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, argtypes, typeargtypes, sym, bestSoFar, allowBoxing, useVarargs, operator);
    ...
    Symbol mostSpecific(Symbol m1,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(m1, m2, env, site, allowBoxing, useVarargs);
	switch (m2.kind) {
        case MTH:
            if (m1 == m2) return m1;
    ...
    Symbol findMethod(Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, name, argtypes, typeargtypes, allowBoxing, useVarargs, operator);
    ...
    private Symbol findMethod(Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, name, argtypes, typeargtypes, intype, abstractok, bestSoFar, allowBoxing, useVarargs, operator);
    ...
    Symbol findFun(Env<AttrContext> env, Name name,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, name, argtypes, typeargtypes, allowBoxing, useVarargs);
    ...
    Symbol findGlobalType(Env<AttrContext> env, Scope scope, Name name) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, scope, name);
	Symbol bestSoFar = typeNotFound;
    ...
    Symbol findIdent(Env<AttrContext> env, Name name, int kind) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, name, kind);
	Symbol bestSoFar = typeNotFound;
        Symbol sym;
    ...
    Symbol findIdentInPackage(Env<AttrContext> env, TypeSymbol pck,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, pck, name, kind);
    ...
    Symbol findIdentInType(Env<AttrContext> env, Type site,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, site, name, kind);
	Symbol bestSoFar = typeNotFound;
        Symbol sym;
        if ((kind & VAR) != 0) {
 ...
 ****************************************************************************/
    ...
    Symbol access(Symbol sym,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, pos, site, name, qualified, argtypes, typeargtypes);
...
//          printscopes(site.tsym.members());//DEBUG
    ...
    Symbol access(Symbol sym,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, pos, site, name, qualified);
	if (sym.kind >= AMBIGUOUS)
 ...
 ****************************************************************************/
    ...
    Symbol resolveIdent(DiagnosticPosition pos, Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, name, kind);
	return access(
    ...
    Symbol resolveMethod(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, name, argtypes, typeargtypes);
    ...
    Symbol resolveQualifiedMethod(DiagnosticPosition pos, Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, site, name, argtypes, typeargtypes);
    ...
    Symbol resolveConstructor(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, site, argtypes, typeargtypes);
    ...
    Symbol resolveConstructor(DiagnosticPosition pos, Env<AttrContext> env,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, site, argtypes, typeargtypes, allowBoxing, useVarargs);
    ...
    Symbol resolveOperator(DiagnosticPosition pos, int optag,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, optag, env, argtypes);
    ...
    Symbol resolveUnaryOperator(DiagnosticPosition pos, int optag, Env<AttrContext> env, Type arg) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, optag, env, arg);
    ...
    Symbol resolveBinaryOperator(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, optag, env, left, right);
    ...
    Symbol resolveSelf(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, c, name);
	Env<AttrContext> env1 = env;
        boolean staticOnly = false;
        while (env1.outer != null) {
            if (isStatic(env1)) staticOnly = true;
    ...
    Symbol resolveSelfContaining(DiagnosticPosition pos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, member);
    ...
    Type resolveImplicitThis(DiagnosticPosition pos, Env<AttrContext> env, Type t) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pos, env, t);
 ...
 ****************************************************************************/
    ...
    public void logAccessError(Env<AttrContext> env, JCTree tree, Type type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(env, tree, type);
    ...
    private class ResolveError extends Symbol {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(v, p);
	throw new AssertionError();
        }
	...
	return debugName + " wrongSym=" + wrongSym + " explanation=" + explanation;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, explanation);
	this.wrongSym = sym;
	...
	switch (kind) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(log, pos, site, name, argtypes, typeargtypes);
