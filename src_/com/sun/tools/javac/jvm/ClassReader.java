...
public class ClassReader extends ClassFile implements Completer {
    ...
    public void init(Symtab syms) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(syms);
	init(syms, true);
    }
    ...
    private void init(Symtab syms, boolean definitive) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(syms, definitive);
    ...
    private void enterMember(ClassSymbol c, Symbol sym) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(c, sym);
 ...
 ***********************************************************************/
    ...
    public BadClassFile badClassFile(String key, Object... args) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, args);
 ...
 ***********************************************************************/
    ...
    char getChar(int bp) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bp);
	return
 ...
 ***********************************************************************/
    ...
    Type sigToType(byte[] sig, int offset, int len) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sig, offset, len);
	signature = sig;
        sigp = offset;
        siglimit = offset + len;
        return sigToType();
	...
	if (!completed) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(outer);
    ...
    List<Type> sigToTypes(char terminator) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(terminator);
 ...
 ***********************************************************************/
    ...
    void unrecognized(Name attrName) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(attrName);
	if (checkClassFile)
    ...
    void readMemberAttr(Symbol sym, Name attrName, int attrLen) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, attrName, attrLen);
    ...
    private Name simpleBinaryName(Name self, Name enclosing) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(self, enclosing);
    ...
    private MethodSymbol findMethod(NameAndType nt, Scope scope, long flags) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(nt, scope, flags);
	if (nt == null)
            return null;
    ...
    private boolean isSameBinaryType(MethodType mt1, MethodType mt2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(mt1, mt2);
    ...
    void readClassAttr(ClassSymbol c, Name attrName, int attrLen) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(c, attrName, attrLen);
    ...
    Code readCode(Symbol owner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(owner);
	nextChar(); // max_stack
        nextChar(); // max_locals
 ...
 ***********************************************************************/
    ...
    void attachParameterAnnotations(final Symbol method) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(method);
    ...
    class AnnotationDeproxy implements ProxyVisitor {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pl);
	...
	ListBuffer<Pair<Symbol.MethodSymbol,Attribute>> buf =
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(container, name);
	CompletionFailure failure = null;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, a);
	Type oldType = type;
            try {
                type = t;
                a.accept(this);
	...
	throw new AssertionError(); // shouldn't happen
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(proxy);
 ...
 ***********************************************************************/
    ...
    void setParameterNames(MethodSymbol sym, Type jvmType) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sym, jvmType);
 ...
 ***********************************************************************/
    ...
    public ClassSymbol defineClass(Name name, Symbol owner) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, owner);
    ...
    public ClassSymbol enterClass(Name flatName, JavaFileObject classFile) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(flatName, classFile);
    ...
    public ClassSymbol enterClass(Name flatname) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(flatname);
	ClassSymbol c = classes.get(flatname);
        if (c == null)
    ...
    private void completeOwners(Symbol o) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(o);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(buf, s);
	try {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(buf, needed);
	if (buf.length < needed) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(c, localized);
 ...
 ***********************************************************************/
    ...
    public boolean packageExists(Name fullname) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(fullname);
    ...
    protected void includeClassFile(PackageSymbol p, JavaFileObject file) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(p, file);
    ...
    protected JavaFileObject preferredFileObject(JavaFileObject a,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(a, b);
	if (preferSource)
    ...
    protected void extraFileActions(PackageSymbol pack, JavaFileObject fe) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pack, fe);
	}
    ...
    private void fillIn(PackageSymbol p) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(p);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(p, location, files);
	currentLoc = location;
	...
	throw new UnsupportedOperationException();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ignoreEncodingErrors);
	throw new UnsupportedOperationException();
        }
	...
	throw new UnsupportedOperationException();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(path);
	return flatname.toString();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(simpleName, kind);
	return true; // fail-safe mode
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(other);
	if (this == other)
                return true;
