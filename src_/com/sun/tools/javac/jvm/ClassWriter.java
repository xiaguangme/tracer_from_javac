 ...
 ******************************************************************/
    ...
    void putChar(ByteBuffer buf, int op, int x) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(buf, op, x);
    ...
    void putInt(ByteBuffer buf, int adr, int x) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(buf, adr, x);
 ...
 ******************************************************************/
    ...
    boolean hasTypeVar(List<Type> l) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(l);
	while (l.nonEmpty()) {
 ...
 ******************************************************************/
    ...
    void writePool(Pool pool) throws PoolOverflow, StringOverflow {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(pool);
 ...
 ******************************************************************/
    ...
    void endAttrs(int index, int count) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(index, count);
    ...
    int writeParameterAttrs(MethodSymbol m) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(m);
 ...
 **********************************************************************/
    ...
    int writeJavaAnnotations(List<Attribute.Compound> attrs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(attrs);
    ...
    RetentionPolicy getRetention(TypeSymbol annotationType) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotationType);
    ...
    class AttributeWriter implements Attribute.Visitor {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(_value);
...
//          log.errWriter.println("enter inner " + c);//DEBUG
    ...
    void writeCode(Code code) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(code);
    ...
    abstract static class StackMapTableFrame {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(writer);
	...
	super.write(writer);
        ...
        *  an entry of compressed stack map frame. */
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(this_frame, prev_pc, prev_locals, types);
	...
	return (t.tag < TypeTags.INT || t.tag == TypeTags.BOOLEAN);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t1, t2, types);
	if (t1 == null) { return t2 == null; }
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(arr1, arr2, types);
    ...
    public void writeClassFile(OutputStream out, ClassSymbol c)
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(out, c);
