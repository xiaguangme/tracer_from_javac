...
public class Main {
    ...
    private Option[] recognizedOptions = RecognizedOptions.getJavaCompilerOptions(new OptionHelper() {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(out);
	Main.this.out = out;
        }
	...
	xhelp();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(f);
    ...
    public Option getOption(String flag) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(flag);
    ...
    public void setOptions(Options options) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(options);
	if (options == null)
    ...
    public void setFatalErrors(boolean fatalErrors) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(fatalErrors);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(optName);
    ...
    public int compile(String[] args, Context context) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(args, context);
                       ...
                       Iterable<? extends Processor> processors)
    {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(args, context, fileObjects, processors);
	if (options == null)
    ...
    void bugMessage(Throwable ex) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(ex);
...
//      System.out.println("(name buffer len = " + Name.names.length + " " + Name.nc);//DEBUG
    ...
    public static void useRawMessages(boolean enable) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(enable);
	if (enable) {
            messages = new Messages(javacBundleName) {
