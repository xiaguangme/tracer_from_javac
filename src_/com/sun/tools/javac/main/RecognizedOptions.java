...
public class RecognizedOptions {
    ...
    static Option[] getJavaCompilerOptions(OptionHelper helper) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(helper);
    ...
    static Option[] getOptions(OptionHelper helper, Set<OptionName> desired) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(helper, desired);
	...
	return new Option[]{
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(options, option);
	options.put("-g:", "none");
                return false;
            }
        },
	...
	options.put("-Xlint:deprecation", option);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(options, option, arg);
	...
	return s.equals("-implicit:none") || s.equals("-implicit:class");
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(options, option, operand);
