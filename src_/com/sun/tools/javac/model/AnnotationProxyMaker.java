...
public class AnnotationProxyMaker {
    ...
    public static <A extends Annotation> A generateAnnotation(
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(anno, annoType);
    ...
    private Object generateValue(MethodSymbol meth, Attribute attr) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(meth, attr);
    ...
    private class ValueVisitor implements Attribute.Visitor {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(attr);
	...
	value = null;       // indicates a type mismatch
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(method, attr);
