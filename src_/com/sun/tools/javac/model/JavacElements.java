...
public class JavacElements implements Elements {
    ...
    public static <A extends Annotation> A getAnnotation(Symbol annotated,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotated, annoType);
    ...
    private <S extends Symbol> S nameToSymbol(String nameStr, Class<S> clazz) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(nameStr, clazz);
    ...
    public JavacSourcePosition getSourcePosition(Element e, AnnotationMirror a) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(e, a);
	Pair<JCTree, JCCompilationUnit> treeTop = getTreeAndTopLevel(e);
        if (treeTop == null)
            return null;
        JCTree tree = treeTop.fst;
    ...
    public JavacSourcePosition getSourcePosition(Element e, AnnotationMirror a,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(e, a, v);
    ...
    private JCTree matchAnnoToTree(AnnotationMirror findme,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(findme, e, tree);
    ...
    private JCTree matchAnnoToTree(Attribute.Compound findme,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(findme, annos, trees);
    ...
    private JCTree matchAnnoToTree(final Attribute.Compound findme,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(findme, attr, tree);
	if (attr == findme)
    ...
    public FilteredMemberList getAllMembers(TypeElement element) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(element);
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(scope, type);
	members:
    ...
    private static boolean containsAnnoOfType(List<Attribute.Compound> annos,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annos, type);
	for (Attribute.Compound anno : annos) {
    ...
    public boolean hides(Element hiderEl, Element hideeEl) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(hiderEl, hideeEl);
    ...
    public boolean overrides(ExecutableElement riderEl,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(riderEl, rideeEl, typeEl);
    ...
    public void printElements(java.io.Writer w, Element... elements) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(w, elements);
    ...
    private static <T> T cast(Class<T> clazz, Object o) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(clazz, o);
