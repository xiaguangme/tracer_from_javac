...
public class JavacTypes implements javax.lang.model.util.Types {
    ...
    public boolean isSubsignature(ExecutableType m1, ExecutableType m2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(m1, m2);
    ...
    public ArrayType getArrayType(TypeMirror componentType) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(componentType);
    ...
    public WildcardType getWildcardType(TypeMirror extendsBound,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(extendsBound, superBound);
	BoundKind bkind;
        Type bound;
    ...
    public DeclaredType getDeclaredType(TypeElement typeElem,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(typeElem, typeArgs);
    ...
    public DeclaredType getDeclaredType(DeclaredType enclosing,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(enclosing, typeElem, typeArgs);
	if (enclosing == null)
    ...
    // where
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(outer, sym, typeArgs);
    ...
    public TypeMirror asMemberOf(DeclaredType containing, Element element) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(containing, element);
    ...
    private void validateTypeNotIn(TypeMirror t, Set<TypeKind> invalidKinds) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, invalidKinds);
