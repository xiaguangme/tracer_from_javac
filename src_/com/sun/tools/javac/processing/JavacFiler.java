...
public class JavacFiler implements Filer, Closeable {
    ...
    public JavaFileObject createSourceFile(CharSequence name,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, originatingElements);
    ...
    private JavaFileObject createSourceOrClassFile(boolean isSourceFile, String name) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(isSourceFile, name);
    ...
    public FileObject createResource(JavaFileManager.Location location,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(location, pkg, relativeName, originatingElements);
    ...
    public FileObject getResource(JavaFileManager.Location location,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(location, pkg, relativeName);
	String strPkg = pkg.toString();
        if (strPkg.length() > 0)
            checkName(strPkg);
    ...
    private void checkName(String name, boolean allowUnnamedPackageInfo) throws FilerException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(name, allowUnnamedPackageInfo);
    ...
    private void checkNameAndExistence(String typename, boolean allowUnnamedPackageInfo) throws FilerException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(typename, allowUnnamedPackageInfo);
    ...
    private void checkFileReopening(FileObject fileObject, boolean addToHistory) throws FilerException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(fileObject, addToHistory);
    ...
    public void newRound(Context context, boolean lastRound) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(context, lastRound);
	this.context = context;
    ...
    private void closeFileObject(String typeName, FileObject fileObject) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(typeName, fileObject);
	if ((typeName != null)) {
            if (!(fileObject instanceof JavaFileObject))
