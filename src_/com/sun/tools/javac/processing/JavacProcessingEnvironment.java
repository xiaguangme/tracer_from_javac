...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
   ...
   public JavacProcessingEnvironment(Context context, Iterable<? extends Processor> processors) {
    ...
    private void initProcessorIterator(Context context, Iterable<? extends Processor> processors) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(context, processors);
    ...
    private Iterator<Processor> handleServiceLoaderUnavailability(String key, Exception e) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, e);
	JavaFileManager fileManager = context.get(JavaFileManager.class);
    ...
    static class ProcessorState {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(source, log);
	SourceVersion procSourceVersion = processor.getSupportedSourceVersion();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(optionName, log);
	boolean valid = isValidOptionName(optionName);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(annotationName);
	for(Pattern p: supportedAnnotationPatterns) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(unmatchedProcessorOptions);
	...
	throw new UnsupportedOperationException();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(re);
	if (!onProcInterator) {
    ...
    private void discoverAndRunProcs(Context context,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(context, annotationsPresent, topLevelClasses, packageInfoFiles);
    ...
    public static class ComputeAnnotationSet extends
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(e, p);
	return p;
        }
    ...
    private boolean callProcessor(Processor proc,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(proc, tes, renv);
	try {
    ...
    throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(context, roots, classSymbols, pckSymbols);
	log = Log.instance(context);
        // Writer for -XprintRounds and -XprintProcessorInfo data
        PrintWriter xout = context.get(Log.outKey);
    ...
    private List<JCCompilationUnit> sourcesToParsedFiles(JavaCompiler compiler)
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(compiler);
	List<JavaFileObject> fileObjects = List.nil();
    ...
    private List<JCCompilationUnit> runLastRound(PrintWriter xout,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(xout, roundNumber, errorStatus, compiler, roots, taskListener);
	roundNumber++;
    ...
    private void updateProcessingState(Context currentContext, boolean lastRound) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(currentContext, lastRound);
    ...
    private void printRoundInfo(PrintWriter xout,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(xout, roundNumber, topLevelClasses, annotationsPresent, lastRound);
    ...
    private List<ClassSymbol> enterNewClassFiles(Context currentContext) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(currentContext);
    ...
    private List<ClassSymbol> getTopLevelClasses(List<? extends JCCompilationUnit> units) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(units);
    ...
    private boolean isPkgInfo(JavaFileObject fo, JavaFileObject.Kind kind) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(fo, kind);
        ...
        throws IOException
    {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(context, shareNames);
    ...
    private boolean needClassLoader(String procNames, Iterable<? extends File> workingpath) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(procNames, workingpath);
	if (procNames != null)
            return true;
    ...
    private class AnnotationCollector extends TreeScanner {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(nodes);
	annotations = List.nil();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(node);
	if (node == null)
                return;
    ...
    public static Pattern importStringToPattern(String s, Processor p, Log log) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(s, p, log);
	if (s.equals("*")) {
            return allMatches;
        } else {
            String t = s;
    ...
    public static boolean isValidOptionName(String optionName) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(optionName);
