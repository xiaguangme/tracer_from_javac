...
public class PrintingProcessor extends AbstractProcessor {
    ...
    public void setWriter(Writer w) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(w);
    ...
    public boolean process(Set<? extends TypeElement> tes,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tes, renv);
    ...
    public static class PrintingElementVisitor
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(e, newLine);
	...
	ElementKind kind = e.getKind();
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(executable);
	...
	printFormalTypeParameters(type.getTypeParameters(), false);
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(typeParams, pad);
