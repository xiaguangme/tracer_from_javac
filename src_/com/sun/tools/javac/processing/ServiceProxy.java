...
class ServiceProxy {
    ...
    private static void fail(Class service, String msg)
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(service, msg);
    ...
    private static void fail(Class service, URL u, int line, String msg)
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(service, u, line, msg);
    ...
    private static boolean parse(Class service, URL u) throws ServiceConfigurationError {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(service, u);
	InputStream in = null;
    ...
    public static boolean hasService(Class<?> service, URL[] urls)
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(service, urls);
	for (URL url: urls) {
            try {
