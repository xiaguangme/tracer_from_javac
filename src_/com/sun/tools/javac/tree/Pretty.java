...
public class Pretty extends JCTree.Visitor {
    ...
    void open(int contextPrec, int ownPrec) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(contextPrec, ownPrec);
    ...
    public void printExpr(JCTree tree, int prec) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, prec);
    ...
    public <T extends JCTree> void printExprs(List<T> trees, String sep) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(trees, sep);
	if (trees.nonEmpty()) {
...
//where
    static int lineEndPos(String s, int start) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(s, start);
	int pos = s.indexOf('\n', start);
    ...
    public void printBlock(List<? extends JCTree> stats) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(stats);
	print("{");
        println();
        indent();
        printStats(stats);
    ...
    public void printUnit(JCCompilationUnit tree, JCClassDecl cdef) throws IOException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tree, cdef);
    ...
    boolean isUsed(final Symbol t, JCTree cdef) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(t, cdef);
