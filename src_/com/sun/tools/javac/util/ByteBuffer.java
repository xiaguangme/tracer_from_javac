...
public class ByteBuffer {
    ...
    private void copy(int size) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(size);
    ...
    public void appendBytes(byte[] bs, int start, int len) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bs, start, len);
    ...
    public void appendBytes(byte[] bs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bs);
