...
public class Constants {
    ...
    public static Object decode(Object value, Type type) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(value, type);
    ...
    private static String formatLong(long lng) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(lng);
	return lng + "L";
    }
    ...
    private static String formatDouble(double d) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(d);
	if (Double.isNaN(d))
            return "0.0/0.0";
