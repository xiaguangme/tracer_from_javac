...
public class Context {
    ...
    public <T> void put(Key<T> key, Factory<T> fac) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, fac);
	checkState(ht);
    ...
    public <T> void put(Key<T> key, T data) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(key, data);
    ...
    private <T> Key<T> key(Class<T> clss) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(clss);
	checkState(kt);
    ...
    public <T> void put(Class<T> clazz, T data) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(clazz, data);
	put(key(clazz), data);
    }
    public <T> void put(Class<T> clazz, Factory<T> fac) {
         
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(clazz, fac);
	put(key(clazz), fac);
    }
