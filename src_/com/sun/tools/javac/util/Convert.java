...
public class Convert {
    ...
    public static int string2int(String s, int radix)
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(s, radix);
	if (radix == 10) {
 ...
 */
    ...
    public static int utf2chars(byte[] src, int sindex,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(src, sindex, dst, dindex, len);
	int i = sindex;
        int j = dindex;
    ...
    public static char[] utf2chars(byte[] src, int sindex, int len) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(src, sindex, len);
    ...
    public static char[] utf2chars(byte[] src) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(src);
