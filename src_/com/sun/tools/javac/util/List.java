...
public class List<A> extends AbstractCollection<A> implements java.util.List<A> {
    ...
    private static List EMPTY_LIST = new List<Object>(null,null) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(tail);
    ...
    public static <A> List<A> of(A x1) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(x1);
    ...
    public static <A> List<A> of(A x1, A x2) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(x1, x2);
    ...
    public static <A> List<A> of(A x1, A x2, A x3) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(x1, x2, x3);
    ...
    public static <A> List<A> of(A x1, A x2, A x3, A... rest) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(x1, x2, x3, rest);
    ...
    public static <A> List<A> fill(int len, A init) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(len, init);
	List<A> l = nil();
    ...
    public List<A> prependList(List<A> xs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(xs);
    ...
    public <T> T[] toArray(T[] vec) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(vec);
	int i = 0;
        List<A> l = this;
        Object[] dest = vec;
    ...
    public String toString(String sep) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(sep);
	if (isEmpty()) {
            return "";
        } else {
    ...
    public static boolean equals(List xs, List ys) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(xs, ys);
    ...
    public static <T> List<T> convert(Class<T> klass, List<?> list) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(klass, list);
	if (list == null)
            return null;
        for (Object o : list)
            klass.cast(o);
    ...
    public boolean addAll(int index, Collection<? extends A> c) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(index, c);
	if (c.isEmpty())
            return false;
        throw new UnsupportedOperationException();
    }
    ...
    public A set(int index, A element) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(index, element);
	throw new UnsupportedOperationException();
    }
    ...
    public java.util.List<A> subList(int fromIndex, int toIndex) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(fromIndex, toIndex);
