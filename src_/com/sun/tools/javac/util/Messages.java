...
public class Messages {
    ...
    public void add(String bundleName) throws MissingResourceException {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bundleName);
    ...
    public void add(ResourceBundle bundle) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bundle);
    ...
    private static String getLocalizedString(List<ResourceBundle> bundles,
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(bundles, key, args);
	String msg = null;
