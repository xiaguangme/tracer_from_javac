...
public class Position {
    ...
    public static LineMap makeLineMap(char[] src, int max, boolean expandTabs) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(src, max, expandTabs);
    ...
    public static int encodePosition(int line, int col) {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(line, col);
	if (line < 1)
    ...
    static class LineMapImpl implements LineMap {
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(src, max);
	int c = 0;
            int i = 0;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(line);
	...
	return getStartPosition(longToInt(line));
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(line, column);
	...
	return getColumnNumber(longToInt(pos));
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(longValue);
	int intValue = (int)longValue;
		...
		org.simonme.tracer.trace.Tracer.traceMethodInvoke(offset);
	}
    }
